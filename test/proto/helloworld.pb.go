...
var fileDescriptor_17b8c58d586b62f2 = []byte{
	...
	0x8a, 0xcf, 0x34, 0x0d, 0x2e, 0x1e, 0xb8, 0x2a, 0xbc, 0xe6, 0x19, 0xdd, 0x62, 0xe4, 0x62, 0x77,
	0x2f, 0x4a, 0x4d, 0x2d, 0x49, 0x2d, 0x12, 0xb2, 0xe3, 0xe2, 0x08, 0x4e, 0xac, 0x04, 0x3b, 0x43,
	0x48, 0x42, 0x0f, 0xc9, 0x4b, 0xc8, 0xae, 0x97, 0x12, 0xc3, 0x22, 0x53, 0x90, 0x53, 0xa9, 0xc4,
	0x20, 0xe4, 0xc2, 0xc5, 0x15, 0x9c, 0x58, 0x09, 0xb5, 0x58, 0x48, 0x0a, 0x59, 0x1d, 0xaa, 0x9b,
	0xa5, 0x24, 0xb0, 0xca, 0x41, 0x4c, 0xf1, 0xe4, 0xe2, 0x47, 0x98, 0xe2, 0x98, 0x9e, 0x98, 0x99,
	0x47, 0xae, 0x51, 0x49, 0x6c, 0xe0, 0xb8, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x7c, 0x25,
	0xf0, 0xba, 0x9f, 0x01, 0x00, 0x00,
}
...
type GreeterClient interface {
	...
	SayGoodbyeAgain(ctx context.Context, in *GoodbyeRequest, opts ...grpc.CallOption) (*GoodbyeReply, error)
}
...
func (c *greeterClient) SayGoodbyeAgain(ctx context.Context, in *GoodbyeRequest, opts ...grpc.CallOption) (*GoodbyeReply, error) {
	out := new(GoodbyeReply)
	err := c.cc.Invoke(ctx, "/helloworld.Greeter/SayGoodbyeAgain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	SayGoodbyeAgain(context.Context, *GoodbyeRequest) (*GoodbyeReply, error)
}
...
func (*UnimplementedGreeterServer) SayGoodbyeAgain(ctx context.Context, req *GoodbyeRequest) (*GoodbyeReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayGoodbyeAgain not implemented")
}
...
func _Greeter_SayGoodbyeAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GoodbyeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).SayGoodbyeAgain(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.Greeter/SayGoodbyeAgain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).SayGoodbyeAgain(ctx, req.(*GoodbyeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SayGoodbyeAgain",
			Handler:    _Greeter_SayGoodbyeAgain_Handler,
		},
	},
